...
if(!["825327566180581386"].some(role => message.member.roles.cache.get(role)) && (!message.member.hasPermission("ADMINISTRATOR"))) 
...
let guild = "812301005198065684"; // SUNUCU ID
...
var booster = message.guild.roles.cache.get("816396703941918722").members.size
