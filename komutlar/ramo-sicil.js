...
if(!["826421960216150026", "825327557292982283", "819313178432634920", "828317705496297522"].some(role => message.member.roles.cache.get(role)) && (!message.member.hasPermission("ADMINISTRATOR"))) 
...
.setFooter(`A R W È N | M O D E R A T I O N`))
};
